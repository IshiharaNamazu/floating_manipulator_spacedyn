...
addpath('./SpaceDyn/src/matlab/spacedyn_v2r1'); % SpaceDyn ���̃T�C�Y�����߂
...
%%%%%%%%%%%% リンクパラメータ定義と変数の初期化 %%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
LP = Sample_LP();%LP１とかにしてもよいi.         Sample_LP()を呼び出してLPに格納
SV = Sample_SV( LP );%SVも名前は自分で定義できる       Sample_SV(LP)を呼び出してSVに格納   同時にサイズを決めている
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%PD制御をする
des_q = [-pi/6 pi/3]'; % 目標関節角[rad]
des_qd = [0 0]'; % 目標関節角速度[rad/s]
kp = 10; % 比例フィードバックゲインP
kd = 5; % 微分フィードバックゲインD
